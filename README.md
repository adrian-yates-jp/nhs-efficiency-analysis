# nhs-efficiency-analysis
Analysis of NHS appointment data (LSE Data Analytics project)

# NHS Primary Care Efficiency: Demand, Utilisation, and Attendance Behaviour

This project analyses NHS primary care appointment data from January 2020 to June 2022, using three datasets covering appointment volumes, service characteristics, and attendance outcomes. Conducted as part of the LSE Data Analytics Career Accelerator, the analysis translates the broad operational challenge of improving NHS efficiency and resilience into a set of focused analytical questions around demand, capacity, service design, and attendance behaviour.

The aim is to understand how primary care resources are used in practice, where inefficiencies arise, and which factors may support improved access and patient outcomes.
...
This repository includes a Jupyter notebook containing data preparation, analysis, and visualisations. Sample versions of large datasets are provided where original files exceed GitHub size limits; all outputs shown in the notebook were generated using the full datasets. Supporting materials include a written report and presentation slides in PDF format. The notebook can be viewed directly on GitHub without downloading.
